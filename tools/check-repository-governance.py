...
AMALGAM_C_PATHS = {
    ...
    "src/migration/convert-project.ts",
    "src/migration/gradle-renderer.ts",
    "src/migration/maven-project.ts",
    "src/migration/migration-reminder.ts",
    "src/migration/project-classifier.ts",
    "src/migration/reminder-state.ts",
    "src/test/suite/convert-project.test.ts",
    "src/test/suite/maven-project.test.ts",
    "src/test/suite/migration-classifier.test.ts",
    "src/test/suite/migration-reminder.test.ts",
